...
%including
  \vspace*{0.1in}
%\lstinputlisting{listings/MPIstencil.c}
...
\subfloat[\tiny Application imbalances.]{\includegraphics[height=1.3in]{./pictures/PersistentImb2}}\label{fig:AmplificationPic3}\hspace*{0.25in}\subfloat[\label{fig:AmplificationPic3}\tiny Mitigated by within-node re-distribution.]{\includegraphics[height=1.3in]{./pictures/PersistentOptimized}}
...
\begin{columns}
  \column{0.5\columnwidth}
  \vspace*{-0.2in}
  \lstinputlisting{listings/threadedCRStatic.c}
  \column{0.5\columnwidth}
  %\includegraphics[scale=0.15]{./images/legend-dynamic}\\
 \vspace*{-0.2in}
  \begin{center}
    \includegraphics[scale=0.31]{images/threadedCR-static}
  \end{center} 
  \vspace*{-0.4in}
  \begin{center} 
...
\vspace*{-0.15in}
\begin{figure}
\lstinputlisting{listings/threadedCRDynamic.c}
\end{figure}
\column{0.5\columnwidth}
  \begin{center}
...
\vspace*{-0.1in}
\begin{figure} 
\lstinputlisting{./listings/threadedCRHybrid.c}
\end{figure}
\column{0.5\columnwidth}
\begin{center}
...
\vspace*{-0.1in}
\begin{figure}
\includegraphics[scale=0.12]{plots/calu-p7-appProfile-dynamicschedule.png}\includegraphics[scale=0.12]{plots/caluP7locAwareSched.png}\includegraphics[scale=0.12]{plots/caluP7locAwareOpt.png}\\{
...
\subfloat[\small Jaguar quasi-persistence in noise.]{\includegraphics[scale=0.41]{./plots/noisepesjaguar.pdf}}
\subfloat[\small Ranger quasi-persistence in noise.]{ \includegraphics[scale=0.41]{./plots/noisepesranger}}
...
%\fbox{
\begin{figure}[ht!]
\includegraphics[width=0.5\columnwidth]{images/mpiDecomppColor.pdf}
\end{figure}
%}
%\end{column}
%\begin{column}{0.5\columnwidth}
...
%\fbox{
\begin{figure}[ht!]
\includegraphics[width=0.5\columnwidth]{images/weightDecomp}
\end{figure}
%}
}
\end{column} 
